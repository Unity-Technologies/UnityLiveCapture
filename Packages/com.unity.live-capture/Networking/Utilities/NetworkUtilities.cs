...
namespace Unity.LiveCapture.Networking
{
    ...
    public static class NetworkUtilities
    {
        ...
        /// <returns>A new array containing the available pairs of IP address and the <see cref="System.Net.NetworkInformation.NetworkInterface"/> that it belongs to.</returns>
